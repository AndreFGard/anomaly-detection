...
\bibitem{review_robot}
M.~S.~R.~Silva, J.~A.~Pereira, and P.~S.~Neto,
``Anomaly Detection Methods in Autonomous Robotic Missions,''
\emph{Sensors (MDPI)},
vol.~24, no.~4, art.~1330, 2024.

\bibitem{mdpi_context}
M.~A.~Zheng, L.~X.~Wang, T.~J.~Hu,
``Unsupervised Anomaly Detection for Autonomous Robots via Mahalanobis SVDD with Audio-IMU Fusion,''
\emph{arXiv preprint arXiv:2505.05811}, 2025.
